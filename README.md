...
[![codecov](https://codecov.io/gh/FarukOzderim/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/FarukOzderim/fastapi-template)
[![CI](https://github.com/FarukOzderim/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/FarukOzderim/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by FarukOzderim

## Install

from source
```bash
git clone https://github.com/FarukOzderim/fastapi-template fastapi_template
cd fastapi_template
make install
```
